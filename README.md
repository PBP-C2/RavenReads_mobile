...
| 5  | **Book Store**                    | Book Store akan berisi card-card berukuran persegi panjang berdiri yang memperlihatkan cover buku, judul, penulis, dan id buku.  Pada bagian atas halaman terdapat button Add Book untuk memasukkan buku ke dalam checkout. Adapun ketika tombol Checkout diklik akan menampilkan form yang meminta input yaitu id buku. Disamping button Add Book terdapat button See Checkout untuk melihat buku apa saja yang dipilih. <br><br>Adapun gambaran detail setiap produk bukupada checkout:<br>- **Title**, yang merupakan judul buku. <br>- **ID**, yang merupakan nomor ID dari buku. <br>- **Author**, yang merupakan penulis dari buku. <br> - **Publisher**, yang merupakan penerbit dari buku tersebut. | Nandika Rafi Atallah       |
</details>
<details>
